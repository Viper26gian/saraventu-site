      ...
      <div className="container-custom relative z-10">
        ...
        <div className="hidden lg:block relative reveal reveal-delay-1" style={{ minHeight: '480px' }}>
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1200 480" preserveAspectRatio="none">
            ...
            />
            <line x1="100" y1="280" x2="100" y2="360" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" strokeDasharray="3 3"/>
            <circle cx="100" cy="365" r="10" fill="#0D1B2A" stroke="#fff" strokeWidth="1.5"/>
            <circle cx="340" cy="240" r="5" fill="#0D1B2A" stroke="#fff" strokeWidth="1.5"/>
            <circle cx="600" cy="280" r="5" fill="#0D1B2A" stroke="#fff" strokeWidth="1.5"/>
            <circle cx="900" cy="250" r="5" fill="#0D1B2A" stroke="#fff" strokeWidth="1.5"/>
            <line x1="340" y1="240" x2="340" y2="380" stroke="rgba(255,255,255,0.35)" strokeWidth="1" strokeDasharray="3 3"/>
            <line x1="600" y1="280" x2="600" y2="420" stroke="rgba(255,255,255,0.35)" strokeWidth="1" strokeDasharray="3 3"/>
          </svg>
          ...
          <div className="absolute" style={{ top: '60px', left: '270px', width: '140px' }}>
            ...
            <p className="text-center text-white text-sm tracking-wider mt-2" style={{fontFamily:"'Cormorant Garamond',serif", fontWeight:500, letterSpacing:'0.08em'}}>
              ULYSSES CAVES
            </p>
